...
public class UpdateExerciseNameTask extends AsyncTask<String, Void, Boolean> {

    private EditExerciseDialog mDialog;
    private Context mContext;
    private ExerciseType mExerciseType;
    private RequiredInputValidator mValidator;

    public UpdateExerciseNameTask(EditExerciseDialog dialog, ExerciseType exerciseType) {
        mDialog = dialog;
